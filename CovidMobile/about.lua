...
local function onAboutBtnRelease()
	...
	-- go to level1.lua scene
	system.openURL("https://www.cdc.gov/coronavirus/2019-ncov/index.html")
...
function scene:create( event )
	...
	local titleLogo = display.newImageRect( "about.png", display.actualContentWidth, display.actualContentHeight )
	titleLogo.anchorX = 0
	titleLogo.anchorY = 0
	titleLogo.x = 0 + display.screenOriginX 
	titleLogo.y = 0 + display.screenOriginY
	...
	aboutBtn = widget.newButton{
		label="Tap for more information about Covid 19",
		defaultColor = {0,0,0,255},
		labelColor = { default={0,0,0,255}, over={0,0,0,128} },
		default="button.png",
		over="button-over.png",
	...
	aboutBtn.y = display.contentHeight - 80
